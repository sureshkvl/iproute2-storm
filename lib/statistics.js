...
(function() {
  var exec, extend, getlinkstats, getroutestats, util;
  ...
  getlinkstats = function(callback) {
    var command;
    command = "ip -s link";
    util.log("netstats executing " + command + "...");
    return exec(command, (function(_this) {
      return function(error, stdout, stderr) {
        var count, i, ob, output, result, tmparr, tmpvars, _i, _j, _len, _len1, _results;
  ...
  getroutestats = function(callback) {
    var command;
    command = "ip -s route";
    util.log("netstats executing " + command + "...");
    return exec(command, (function(_this) {
